...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AMageCharacter_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AMageCharacter_SpawnMagicBall, "SpawnMagicBall" }, // 3445578322
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AMageCharacter_Statics::NewProp_BallSpawnPoint = { "BallSpawnPoint", nullptr, (EPropertyFlags)0x0010000000080009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AMageCharacter, BallSpawnPoint), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AMageCharacter_Statics::NewProp_BallSpawnPoint_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMageCharacter_Statics::NewProp_BallSpawnPoint_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_AMageCharacter_Statics::NewProp_BorderPoleClass = { "BorderPoleClass", nullptr, (EPropertyFlags)0x0014000000010001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AMageCharacter, BorderPoleClass), Z_Construct_UClass_UClass, Z_Construct_UClass_ABorderPole_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AMageCharacter_Statics::NewProp_BorderPoleClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMageCharacter_Statics::NewProp_BorderPoleClass_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AMageCharacter_Statics::NewProp_TeleportSound = { "TeleportSound", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AMageCharacter, TeleportSound), Z_Construct_UClass_USoundBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AMageCharacter_Statics::NewProp_TeleportSound_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMageCharacter_Statics::NewProp_TeleportSound_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE5_nauka_FPSPrototype_Source_FPSPrototype_MageCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMageCharacter, AMageCharacter::StaticClass, TEXT("AMageCharacter"), &Z_Registration_Info_UClass_AMageCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMageCharacter), 3828177234U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE5_nauka_FPSPrototype_Source_FPSPrototype_MageCharacter_h_960256498(TEXT("/Script/FPSPrototype"),
